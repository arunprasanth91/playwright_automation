...
4. Browser context - Playwright can create multiple isolated "browser contexts" within a single browser instance. allows extremely fast parallel execution and session isolation.
